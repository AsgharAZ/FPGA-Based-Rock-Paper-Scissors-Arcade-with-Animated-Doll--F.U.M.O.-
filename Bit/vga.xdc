...
set_property PACKAGE_PIN V17 [get_ports {states[0]}]
set_property PACKAGE_PIN V16 [get_ports {states[1]}]
set_property PACKAGE_PIN W16 [get_ports {states[2]}]
set_property PACKAGE_PIN W17 [get_ports {states[3]}]
